...
public class FibonacciRowTest {
    ...
    public Object[][] getRange() {
        return new Object[][]{
            {new long[] {7, 23}, new ArrayList<>(Arrays.asList(8L, 13L, 21L))},
            {new long[] {144, 987}, new ArrayList<>(Arrays.asList(144L, 233L, 377L, 610L, 987L))},
            {new long[] {5, 5}, new ArrayList<>(Collections.singletonList(5L))},
            {new long[] {5, 5}, new ArrayList<>(Collections.singletonList(5L))},
            {new long[] {0, 10}, new ArrayList<>(Arrays.asList(0L, 1L, 1L, 2L, 3L, 5L, 8L))},
        };
    }
