    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            if (!scanner.hasNextDouble() || (sides[0] = scanner.nextDouble()) <= 0) {
                System.out.println(
                        "Please, enter a positive double value using comma to "
                                + "separate a whole and a decimal part\n\n");
                continue;
            } else {
                ...
                if (!scanner.hasNextDouble() || (sides[1] = scanner.nextDouble()) <= 0) {
                    ...
                    if (!scanner.hasNextDouble() || (sides[2] = scanner.nextDouble()) <= 0) {
                        System.out.println(
                                "Please, enter a positive double value using comma "
                                        + "to separate a whole and a decimal part\n\n");
                        continue;
                    } else {
                        System.out.print("Horizontal side: ");
                        scanner = new Scanner(System.in);
